...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(difference);
         ...
         // Static method call with two parameters that returns an int
         int multiply = multiply(1, 1);
         System.out.println(multiply);

          // Static method call with two parameters that returns an int
        int division = division(1, 1);
        System.out.println(division);

        boolean kiker = equal( 1, 1);
        System.out.println(kiker);
    }
    ...
    // Static method with two parameter with return type
